...
void Jacobian( const sensor_msgs::JointState& jointstate, double J[3][3] ){
  ...
  J[0][0] =  -0.1914*cos(q1) - 0.425*sin(q2 + 1.571)*sin(q1) - 0.4869*cos(q2 + 1.571)
    *sin(q1)*sin(q3) - 0.4869*sin(q2 + 1.571)*cos(q3)*sin(q1);
  J[0][1] =  0.425*cos(q2 + 1.571)*cos(q1) + 0.4869*cos(q2 + 1.571)*cos(q1)*cos(q3) 
    - 0.4869*sin(q2 + 1.571)*cos(q1)*sin(q3);
  J[0][2] =  0.4869*cos(q2 + 1.571)*cos(q1)*cos(q3) - 0.4869*sin(q2 + 1.571)*cos(q1)*sin(q3);

  J[1][0] = 0.425*sin(q2 + 1.571)*cos(q1) - 0.1914*sin(q1) + 0.4869*cos(q2 + 1.571)
    *cos(q1)*sin(q3) + 0.4869*sin(q2 + 1.571)*cos(q1)*cos(q3);
  J[1][1] =  0.425*cos(q2 + 1.571)*sin(q1) + 0.4869*cos(q2 + 1.571)*cos(q3)*sin(q1) 
    - 0.4869*sin(q2 + 1.571)*sin(q1)*sin(q3);
  J[1][2] = 0.4869*cos(q2 + 1.571)*cos(q3)*sin(q1) - 0.4869*sin(q2 + 1.571)*sin(q1)*sin(q3);

  J[2][0] = 0;
  J[2][1] = -0.425*sin(q2 + 1.571) - 0.4869*cos(q2 + 1.571)*sin(q3) - 0.4869*sin(q2 + 1.571)*cos(q3);
  J[2][2] = -0.4869*cos(q2 + 1.571)*sin(q3) - 0.4869*sin(q2 + 1.571)*cos(q3);
